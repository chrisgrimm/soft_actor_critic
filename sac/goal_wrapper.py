...
class GoalWrapper(object):
    ...
    In the below functions: 
        "obs_part" refers to the raw observation that comes off of the environment being wrapped.
        "goal" refers to some notion of a goal-state that is free to be defined in the wrapper.
            however, goals must be able to be constructed from obs_parts for hindsight to work.
        the observations that are produced by the goal wrapper are some amalgamation of the obs_part and the goal
            defined by the obs_from_obs_part_and_goal function.   
    '''
